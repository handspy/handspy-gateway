...
import { AnnotationTypeComponent } from 'app/entities/sampling/annotation-type/annotation-type.component';
...
describe('Component Tests', () => {
  describe('AnnotationType Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.annotationTypes && comp.annotationTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
