...
import { TaskUpdateComponent } from 'app/entities/project/task/task-update.component';
import { TaskService } from 'app/entities/project/task/task.service';
import { Task } from 'app/shared/model/project/task.model';
