...
import { DeviceDeleteDialogComponent } from 'app/entities/sampling/device/device-delete-dialog.component';
import { DeviceService } from 'app/entities/sampling/device/device.service';
